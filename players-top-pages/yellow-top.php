...
$count = 1;
$query = "SELECT * FROM players WHERE player_yellow>0 ORDER BY player_yellow DESC, player_games, player_minutes LIMIT 50";
...
<div class="goals-section">
	<div class="top-heading">
		<h2>Получили больше всего желтых карточек</h2>
	</div>
	...
	<?php 
		foreach ($players as $player) {?>
			<div class="player-row">
				...
				if($count==2) { silver(); }
				if($count==3) { bronze(); }?>>
					<p><?php echo $player['player_yellow'];
					$count++;?></p>
				</div>
			</div>
		<?php } ?>
