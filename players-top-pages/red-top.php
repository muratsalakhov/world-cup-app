...
$count = 1;
$query = "SELECT * FROM players WHERE player_red>0 ORDER BY player_red DESC, player_games, player_minutes LIMIT 50";
...
<div class="goals-section">
	<div class="top-heading">
		<h2>Получили больше всего красных карточек</h2>
	</div>
