...
$count = 1;
$query = "SELECT * FROM players WHERE player_goals>0 ORDER BY player_goals DESC, player_games, player_minutes LIMIT 50";
...
<div class="goals-section">
	<div class="top-heading">
		<h2>Список лучших бомбардиров</h2>
	</div>
	...
	<?php 
		foreach ($players as $player) {?>
			<div class="player-row">
				...
				if($count==2) { silver(); }
				if($count==3) { bronze(); }?>>
					<p><?php echo $player['player_goals'];
					$count++;?></p>
				</div>
			</div>
		<?php } ?>
